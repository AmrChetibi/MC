...
class FiniteAutomaton:
    ...
    """ It determines the \delta^{*} function given a subset of states B and a word u.
    ...
    """
    Method that recursively marks a pair of states qi and qj as indistinguisable and,
                ...
                if indistinguisable_states[i][j]:
                    for symbol in alphabet_symbols:
                        ...
                        if not transition_pi == transition_pj:
                            ...
                            """ If the index of pi is lower than the index of pj, interchange both values """
